...
(deftest known-product-types-are-valid
  (doseq [pt [:electric-motor :generator :transformer
...
(deftest typical-dielectric-test-kv-is-valid
  ...
  (is (r/dielectric-test-kv-valid? 250.0))
  (is (r/dielectric-test-kv-valid? 2500.0)))
...
(deftest history-is-append-only
  (let [c1 (r/register-maintenance "mnt-1" "winder-001" 0)
        hist (r/append [] c1)
        c2 (r/register-maintenance "mnt-2" "winder-001" 1)
