(ns elecequipmfg.phase
  "Phase 0->3 staged rollout for the electric motor/generator/
  ...
  consequence (a winding/assembly/test-bench-equipment maintenance
  window means production downtime, and the equipment ends up
  actually touched); it is always a human plant supervisor's call.
  `elecequipmfg.governor`'s `equipment-actuate-blocked-violations`
...
(defn verdict->disposition
  "Map an Electrical Equipment Plant Operations Governor verdict to a
