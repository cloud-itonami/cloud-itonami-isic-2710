...
`cloud-itonami-isic-2710` is an OSS open-business blueprint for
electric-motor/generator/transformer/distribution-and-control-
apparatus plant operations coordination.

## Maintainers
Maintainers may merge changes that preserve these invariants:
- a winding/assembly/test-bench-equipment action the governor refuses is never dispatched to hardware.
- the Electrical Equipment Plant Operations Governor remains independent of the advisor.
...
- bypassing winding/assembly/test-bench-equipment-control or record policy checks
