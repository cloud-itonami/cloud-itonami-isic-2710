# Operator Quickstart — Manufacture of electric motors, generators, transformers and electricity distribution and control apparatus

Shortest path from clone to a verified local dry-run for **ISIC 2710** (`cloud-itonami-isic-2710`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-2710.git
cd cloud-itonami-isic-2710
```
...
- Blueprint governor key: `electrical-equipment-plant-operations-governor`
- Likely source path: `elecequipmfg.governor.cljc`
